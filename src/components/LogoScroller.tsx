...
// Import logo images
import anptec from "../clientes-assets/anptec.webp";
import cedep from "../clientes-assets/cedep.webp";
import colormaq from "../clientes-assets/colormaq.webp";
import farmacia from "../clientes-assets/farmacia.webp";
import globoaves from "../clientes-assets/globoaves.webp";
import penha from "../clientes-assets/penha.webp";
import progetto from "../clientes-assets/progetto.webp";
import riquezagarage from "../clientes-assets/riquezagarage.webp";
import tucano from "../clientes-assets/tucano.webp";
...
const LogoScroller: React.FC = () => {
  ...
  return (
    <>
      <h1 id="scrollerTitle">
        Alguns de nossos <span id="clientesAmarelo">clientes:</span>
      </h1>
