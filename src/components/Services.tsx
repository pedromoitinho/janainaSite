...
import assesoriaImg from "../assets/assessoria.webp";
import psicologiaImg from "../assets/psicologia.webp";
import saudeImg from "../assets/saude.webp";
import segurancaImg from "../assets/segurança.webp";
import treinamentosImg from "../assets/treinamentos.webp";
...
const services: Service[] = [
  {
    ...
    description:
      "Desenvolvimento e implementação de programas personalizados para gestão de riscos e prevenção de acidentes.",
    image: segurancaImg,
    link: "#",
    id: "imgProgramasDeSeguranca",
    details:
      "Soluções em segurança do trabalho, com foco na gestão de documentos e treinamentos. Conformidade com a legislação vigente e contribuição para a prevenção de acidentes<hr/>",
    services: [
  ...
  },
  {
    ...
    description:
      "Soluções completas para garantir a segurança e bem-estar dos colaboradores no ambiente de trabalho.",
    image: psicologiaImg,
    link: "#",
    id: "imgSegurancaDoTrabalho",
    details:
      "Aplicação de avaliações psicossociais para promover o bem-estar mental dos colaboradores.<hr/>",
    services: [
  ...
  },
  {
    ...
    description:
      "Programas de saúde ocupacional para promover o bem-estar e prevenir doenças relacionadas ao trabalho.",
    image: saudeImg,
    link: "#",
    id: "imgGestaoOcupacional",
    details:
      "Programas de prevenção e acompanhamento médico, garantindo o bem-estar dos colaboradores e a conformidade com as exigências legais.<hr/>",
    services: [
  ...
  },
  {
    ...
    description:
      "Consultoria especializada para adequação às normas regulamentadoras e legislação vigente.",
    image: assesoriaImg,
    link: "#",
    id: "imgAssessoriaTecnica",
    details:
      "Assessoria técnica para suporte na gestão, garantindo o correto atendimento às normas regulamentadoras e otimizando processos internos.<hr/>",
    services: [
  ...
  },
  {
    ...
    description:
      "Capacitação e desenvolvimento de equipes para promover uma cultura de segurança e prevenção.",
    image: treinamentosImg,
    link: "#",
    id: "imgTreinamentosCorporativos",
    details:
      "Treinamentos focados no desenvolvimento de soft skills. As capacitações são personalizadas de acordo com as demandas da empresa e direcionadas para líderes e equipes.<hr/>",
    services: [
  ...
  useEffect(() => {
    ...
    return () => {
      if (document.body.style.position === "fixed") {
        // Check if modal was likely open
          ...
          {services.map((service, index) => (
            <div key={index} className="card">
              ...
              <div className="content">
                ...
                <button onClick={(e) => openModal(service, e)} className="link">
                  Saiba Mais
                  <svg
            ...
            <div className="modal-body">
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: selectedService.details || "",
                }}
              ></p>
                ...
                <div className="modal-benefits">
                  ...
                  <ul>
                    {selectedService.services.map((service, index) => {
                      ...
                      const hasNoBulletStyle =
                        service.includes("font-weight:bold");
                      return (
                        <li
                          key={index}
                ...
                <div className="modal-benefits">
                  ...
                  <ul>
                    {selectedService.benefits.map((benefit, index) => {
                      // Determine if this item should have no bullet
                      const hasNoBulletStyle =
                        benefit.includes("font-weight:bold");
                      return (
                        <li
                          key={index}
                          className={hasNoBulletStyle ? "no-bullet" : ""}
