import "./App.css";
import janainaImg from "./assets/janaina.webp";
...
function App() {
  ...
  useEffect(() => {
    ...
    const solucoesObserver = new window.IntersectionObserver(([entry]) => {
      ...
      <div className="app-content">
        <div className="heroDiv">
          <img
            src={janainaImg}
            id="heroImage"
            alt="Vitais Consultoria - Especialistas em segurança do trabalho e saúde ocupacional"
            loading="lazy"
          />
          <div className="heroText">
            <h1>Sua visão, nossa estratégia</h1>
            <h2 className="subtitle-seo">
              Segurança do Trabalho e Psicologia Organizacional em Feira de
              Santana
            </h2>
          </div>
          <div className="heroButton">
            <Link to="/forms" id="buttonOrcamento">
              Começar agora
            </Link>
          </div>
        </div>
        ...
        >
          <h1>
            Nossas <span id="solucoesAmarelo">soluções</span>:
          </h1>
